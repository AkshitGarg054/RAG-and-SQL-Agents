...
class ChinookSQLAgent:
    ...
    Attributes:
        sql_agent_llm (ChatGoogleGenerativeAI): The language model used for interpreting and interacting with the database.
    ...
    def __init__(self, sqldb_directory: str, llm: str, llm_temerature: float) -> None:
        ...
        category_chain = prompt | self.sql_agent_llm.with_structured_output(TableList) | (lambda x: x.tables)
